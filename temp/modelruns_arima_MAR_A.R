...
gauss_sim_randMiss_autoCorr_01 <- readRDS("/caldera/hovenweep/projects/usgs/ecosystems/sbsc/DrylandEcologyTeam/gridSTDF/temp/gauss_sim_randMiss_A.rds")
...
OutFile <- paste("./model_results/gauss_sim_randMiss_modelResults_A/")
#########################################################################################
### MY ARIMA FUNCTIONS #####
##########################################################################################
